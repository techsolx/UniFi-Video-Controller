...
RUN apt-key adv --no-tty --keyserver hkp://keyserver.ubuntu.com:80 --recv B00A0BD1E2C63C11 && \
...
# Patch log4j vuln
RUN wget -q -O apache-log4j-2.17.0-bin.tar.gz https://archive.apache.org/dist/logging/log4j/2.17.0/apache-log4j-2.17.0-bin.tar.gz && \
